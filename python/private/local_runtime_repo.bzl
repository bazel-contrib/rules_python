...
_TOOLCHAIN_IMPL_TEMPLATE = """\\\r
# Generated by python/private/local_runtime_repo.bzl\r
\r
load("@rules_python//python/private:local_runtime_repo_setup.bzl", "define_local_runtime_toolchain_impl")\r
\r
define_local_runtime_toolchain_impl(\r
    name = "local_runtime",\r
    lib_ext = "{lib_ext}",\r
    major = "{major}",\r
    minor = "{minor}",\r
    micro = "{micro}",\r
    interpreter_path = "{interpreter_path}",\r
    implementation_name = "{implementation_name}",\r
    os = "{os}",\r
)\r
"""
